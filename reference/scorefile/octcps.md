...
Convert frequency (Hz) to linear octaves.
...
**octcps** returns a corresponding linear octave value for a given
frequency value (Hz). Linear octaves are similar to octave.pitch-class
...
[cpspch](cpspch.html), [midipch](midipch.html), [octlet](octlet.html),
